...
BOT_TOKEN = environ.get('BOT_TOKEN', '8217031502:AAHTh4aAAr8JukK8FJ0Qncf32hRcFRz6jRE')
# Bot settings
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003068437895').split()]
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1003068437895))
